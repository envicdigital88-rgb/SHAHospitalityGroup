              ...
              <form onSubmit={handleSubmit} className="glass-card p-8 lg:p-12 space-y-8">
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label htmlFor="rq-name" className="block text-xs text-slategray tracking-wider uppercase mb-2">Full Name *</label>
                      <input id="rq-name" type="text" value={form.name}
                        onChange={(e) => setForm({ ...form, name: e.target.value })}
                        className={inputClass} placeholder="Your full name" />
                      {errors.name && <p className="text-xs text-red-400 mt-1.5">{errors.name}</p>}
                    </div>
                    <div>
                      <label htmlFor="rq-company" className="block text-xs text-slategray tracking-wider uppercase mb-2">Company Name</label>
                      <input id="rq-company" type="text" value={form.company}
                        onChange={(e) => setForm({ ...form, company: e.target.value })}
                        className={inputClass} placeholder="Your company" />
                    </div>
                    <div>
                      <label htmlFor="rq-email" className="block text-xs text-slategray tracking-wider uppercase mb-2">Email Address *</label>
                      <input id="rq-email" type="email" value={form.email}
                        onChange={(e) => setForm({ ...form, email: e.target.value })}
                        className={inputClass} placeholder="you@email.com" />
                      {errors.email && <p className="text-xs text-red-400 mt-1.5">{errors.email}</p>}
                    </div>
                    <div>
                      <label htmlFor="rq-phone" className="block text-xs text-slategray tracking-wider uppercase mb-2">Phone Number *</label>
                      <input id="rq-phone" type="tel" value={form.phone}
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label htmlFor="rq-eventType" className="block text-xs text-slategray tracking-wider uppercase mb-2">Event Type *</label>
                      <select id="rq-eventType" value={form.eventType}
                    ...
                    <div>
                      <label htmlFor="rq-location" className="block text-xs text-slategray tracking-wider uppercase mb-2">Event Location / Emirate *</label>
                      <input id="rq-location" type="text" value={form.location}
                    ...
                    <div>
                      <label htmlFor="rq-eventDate" className="block text-xs text-slategray tracking-wider uppercase mb-2">Preferred Event Date</label>
                      <input id="rq-eventDate" type="date" value={form.eventDate}
                        onChange={(e) => setForm({ ...form, eventDate: e.target.value })}
                        className={inputClass} />
                    </div>
                    <div>
                      <label htmlFor="rq-guestCount" className="block text-xs text-slategray tracking-wider uppercase mb-2">Estimated Guest Count</label>
                      <input id="rq-guestCount" type="number" value={form.guestCount}
                ...
                <div>
                  ...
                  <div className="space-y-5">
                    <div>
                      <label htmlFor="rq-budget" className="block text-xs text-slategray tracking-wider uppercase mb-2">Budget Range (Optional)</label>
                      <select id="rq-budget" value={form.budget}
                    ...
                    <div>
                      <label htmlFor="rq-requirements" className="block text-xs text-slategray tracking-wider uppercase mb-2">Additional Requirements</label>
                      <textarea id="rq-requirements" rows={4} value={form.requirements}
