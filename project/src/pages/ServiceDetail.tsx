    ...
    <>
      <section className="relative min-h-[70vh] flex items-end overflow-hidden pt-24">
        ...
        <div className="relative container-luxury pb-16">
          <Reveal>
            <Link to="/services" className="inline-flex items-center gap-2 text-sm text-slategray hover:text-champagne transition-colors mb-6">
              ...
              <Reveal delay={0.2}>
                <div className="glass-card p-8 sticky top-24">
                  ...
                  <div className="pt-6 border-t border-champagne/10">
                    ...
                    <Link to="/request-a-quote" className="btn-primary w-full mb-3">
