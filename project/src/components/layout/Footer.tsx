        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.to}>
                  <Link to={link.to} className="text-sm text-slategray hover:text-champagne transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
              <li>
                <Link to="/request-a-quote" className="text-sm text-slategray hover:text-champagne transition-colors">
                  Request a Quote
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/services" className="text-sm text-champagne hover:text-champagne-light transition-colors flex items-center gap-1">
          ...
          <div>
            ...
            <Link to="/request-a-quote" className="btn-outline mt-6 !py-2.5 !px-5 text-xs">
              Request a Quote
            </Link>
          </div>
        </div>
